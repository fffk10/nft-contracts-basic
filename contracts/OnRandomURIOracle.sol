...
contract OnRandomURIOracle is ERC721URIStorage, VRFConsumerBaseV2 {
    /**
     * @dev
     * - _tokenIdsはCounters.Counterの全関数を利用可能
     */
    ...
    function nftMint() public onlyOwner {
        ...
        string memory imageData = _getImage(
            colorNum1,
            colorNum2,
            colorNum3,
            colorNum4
        ...
        bytes memory metaData = abi.encodePacked(
            ...
            '","description": "Randomly colored square.",',
    ...
    /**
     * @dev     引数で渡されるカラーコードを指定したSVGデータを返す
     */
    function _getImage(
        uint256 colorNum1,
        uint256 colorNum2,
